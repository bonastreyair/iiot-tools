# Sensors
## GPS
This example uses TinyGPSPlus library to translate the GPS [NMEA protocol](https://www.gpsinformation.org/dale/nmea.htm#GGA) for easy implementation.
...
### Libraries
- [_TinyGPS++_](https://github.com/mikalhart/TinyGPSPlus) by Mikal Hart - Installed from GitHub
